...
const EVENTS = {
	...
	googleApps: {
		...
		cancelButtonClick( section ) {
			analytics.ga.recordEvent( 'Domain Search', 'Clicked "Cancel" Button in Google Apps Dialog' );
		...
		formSubmit( section ) {
			analytics.ga.recordEvent( 'Domain Search', 'Submitted Form in Google Apps Dialog' );
